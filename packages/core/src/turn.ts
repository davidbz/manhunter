 ...
 * MVP action puts a hunter unit anywhere (PLAN M8 owns the ones that do). This phase leaves the
 ...
 * resources"). Nothing reads it in the MVP - the override events it would trigger are PLAN M8 -
